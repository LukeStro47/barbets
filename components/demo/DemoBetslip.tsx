    ...
    <>
      {isOpen && (
        <div className="animate-demo-fade fixed inset-0 z-40 flex items-end justify-center bg-ink/45" onClick={onClose}>
          <div
            className="animate-demo-sheet-up w-full max-w-lg rounded-t-[22px] bg-gradient-to-br from-ink via-ink to-ink pb-[calc(env(safe-area-inset-bottom)+20px)]"
          ...
          >
            ...
            <div className="space-y-4 px-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-display text-base font-bold text-white">Place your bet</p>
                ...
                <button
                  ...
                  onClick={onClose}
                  aria-label="Close"
                  className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-white/[0.18]"
                >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={cn(
                    ...
                    side === 'yes' ? 'border-signal bg-signal/15 text-on-ink' : 'border-white/15 text-white/60'
                  )}
                >
                  Yes
                </button>
                <button
                  ...
                  className={cn(
                    'flex-1 rounded-full border py-2 text-sm font-extrabold uppercase transition-colors',
                    side === 'no' ? 'border-signal bg-signal/15 text-on-ink' : 'border-white/15 text-white/60'
                  )}
                >
                  No
                </button>
              ...
              <div>
                ...
                <div className="mb-2.5 flex gap-2">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      amountNum === balance ? 'border-signal bg-signal text-ink' : 'border-white/15 bg-white/5 text-white/75'
                    )}
                  >
                    Max
                  </button>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 pr-20 text-xl font-extrabold text-white focus:border-signal focus:outline-none"
                  />
              ...
              <div className="space-y-1.5 border-t border-white/10 pt-3">
                <div className="flex items-baseline justify-between gap-3">
                  ...
                  <span className="text-right text-base font-extrabold text-on-ink">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-sm font-extrabold text-white">{formatTokens(previewPayout)} back at these odds</span>
                </div>
              </div>
              ...
              <button
                ...
                onClick={submit}
                className="w-full rounded-full bg-signal py-3.5 text-base font-extrabold text-ink transition-all duration-150 hover:bg-signal active:scale-[0.97] disabled:bg-signal/30 disabled:text-ink/40 disabled:active:scale-100"
              >
                Confirm bet
              </button>
            </div>
      ...
      {confirmed && (
        <div
          className="animate-demo-fade fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-gradient-to-br from-ink via-ink to-ink px-8 text-center"
          style={{ animationDuration: '300ms' }}
        >
          <svg width="72" height="72" viewBox="0 0 76 76" fill="none" className="animate-bet-check-circle">
            <circle cx="38" cy="38" r="36" className="fill-signal" />
            <path
              d="M24 39l9 9 19-19"
          ...
          <div className="space-y-1.5">
            <p className="font-display text-2xl font-bold text-white">Bet placed</p>
          ...
          <button
            ...
            className="mt-4 w-full max-w-xs rounded-full bg-signal py-3.5 text-base font-extrabold text-ink transition-all duration-150 hover:bg-signal active:scale-[0.97]"
          >
            Continue
          </button>
        </div>
