 ...
 */
export function DemoBetslip({ balance, onConfirmed }: { balance: number; onConfirmed: (side: DemoSide, amount: number) => void }) {
  ...
  return (
    <>
      <button
        ...
        className="w-full rounded-full bg-honey-500 py-3.5 text-base font-bold text-espresso-950 transition-colors hover:bg-honey-600"
      >
        Place a bet
      </button>

      {isOpen && (
        <div className="fixed inset-0 z-40 flex items-end justify-center bg-espresso-950/45" onClick={() => setIsOpen(false)}>
          <div
            className="w-full max-w-lg rounded-t-[22px] bg-gradient-to-br from-espresso-900 via-espresso-800 to-espresso-700 pb-[calc(env(safe-area-inset-bottom)+20px)]"
            ...
            <div className="space-y-4 px-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-white/50">Pick a side and how much of your balance to risk.</p>
                </div>
                <button
                  type="button"
      ...
      {confirmed && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-gradient-to-br from-espresso-900 via-espresso-800 to-espresso-700 px-8 text-center">
          ...
          <button
            type="button"
            onClick={() => onConfirmed(confirmed.side, confirmed.amount)}
