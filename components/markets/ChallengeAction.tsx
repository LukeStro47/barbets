        ...
        <>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 rounded-full border border-hairline px-4 py-2.5 text-sm font-semibold text-ink transition-colors hover:bg-rule"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 rounded-full bg-alert px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-alert disabled:opacity-50"
            >
              Confirm
            </button>
          </div>
