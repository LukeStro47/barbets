...
export function SettlementCard({ moneySplit, description }: { moneySplit?: [SideShare, SideShare]; description: string }) {
  return (
    <Card className="space-y-3.5">
      ...
      <div>
        <p className="mb-1 text-[11.5px] font-extrabold tracking-[0.08em] text-faint uppercase">How this settles</p>
        <p className="text-[14.5px] leading-[1.45] text-muted">{description}</p>
      </div>
    </Card>
  );
}
